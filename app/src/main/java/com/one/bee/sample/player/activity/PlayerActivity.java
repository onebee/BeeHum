package com.one.bee.sample.player.activity;
...
import com.one.bee.sample.player.model.MusicData;
import com.one.bee.sample.player.service.MusicService;
import com.one.bee.sample.player.utils.DisplayUtil;
import com.one.bee.sample.player.utils.FastBlurUtil;
import com.one.bee.sample.player.widget.BackgourndAnimationRelativeLayout;
import com.one.bee.sample.player.widget.DiscView;
...
import static com.one.bee.sample.player.widget.DiscView.DURATION_NEEDLE_ANIAMTOR;


public class PlayerActivity extends HiBaseActivity implements DiscView.IPlayInfo, View
        .OnClickListener {
